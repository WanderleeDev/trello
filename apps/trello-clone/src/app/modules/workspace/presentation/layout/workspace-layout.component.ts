...
@Component({
  ...
  template: `
    ...
    <main
      class="flex justify-center items-start w-full mx-auto mt-10 lg:w-[min(100%,70rem)] overflow-x-hidden"
    >
  ...
  standalone: true,
  imports: [NavComponent, BannerComponent, SidebarComponent, RouterOutlet],
})
